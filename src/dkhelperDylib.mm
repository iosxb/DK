...
static void _logos_method$_ungrouped$CMessageMgr$onNewSyncNotAddDBMessage$(_LOGOS_SELF_TYPE_NORMAL CMessageMgr* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, CMessageWrap * arg1) {

    NSString *msgContent = arg1.m_nsContent;
    if (![msgContent hasPrefix:@"<sysmsg type=\"revokemsg\"><revokemsg>"]){
        _logos_orig$_ungrouped$CMessageMgr$onNewSyncNotAddDBMessage$(self, _cmd, arg1);return;
    }
...
static void _logos_method$_ungrouped$CMessageMgr$onNewSyncAddMessage$(_LOGOS_SELF_TYPE_NORMAL CMessageMgr* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, CMessageWrap * wrap) {
    _logos_orig$_ungrouped$CMessageMgr$onNewSyncAddMessage$(self, _cmd, wrap);
...
static NSInteger _logos_method$_ungrouped$UploadDeviceStepReq$m7StepCount(_LOGOS_SELF_TYPE_NORMAL UploadDeviceStepReq* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    NSInteger stepCount = _logos_orig$_ungrouped$UploadDeviceStepReq$m7StepCount(self, _cmd);
    NSInteger newStepCount = DKHelperConfig.changedSteps;

    return DKHelperConfig.changeSteps ? newStepCount : stepCount;
}

static NSInteger _logos_method$_ungrouped$UploadDeviceStepReq$hkStepCount(_LOGOS_SELF_TYPE_NORMAL UploadDeviceStepReq* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    NSInteger stepCount = _logos_orig$_ungrouped$UploadDeviceStepReq$hkStepCount(self, _cmd);
    NSInteger newStepCount = DKHelperConfig.changedSteps;
...
static void _logos_method$_ungrouped$MicroMessengerAppDelegate$showLaunchVideo(_LOGOS_SELF_TYPE_NORMAL MicroMessengerAppDelegate* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd){
...
static void _logos_method$_ungrouped$MMMainSceneDelegate$sceneWillEnterForeground$(_LOGOS_SELF_TYPE_NORMAL MMMainSceneDelegate* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1){
    if (!DKHelperConfig.dkLaunchEnable || ![DKHelper vapFileExit] || isShowLaunchVideo ){return _logos_orig$_ungrouped$MMMainSceneDelegate$sceneWillEnterForeground$(self, _cmd, arg1);}
    [[_logos_static_class_lookup$MicroMessengerAppDelegate() GlobalInstance] showLaunchVideo];
    isShowLaunchVideo = true;
    _logos_orig$_ungrouped$MMMainSceneDelegate$sceneWillEnterForeground$(self, _cmd, arg1);
}




static void _logos_method$_ungrouped$WCPayLogicMgr$insideCallBackGetTransferPrepayResponse$OnRequest$(_LOGOS_SELF_TYPE_NORMAL WCPayLogicMgr* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, id arg2){
    HBLogDebug(@"-[<WCPayLogicMgr: %p> insideCallBackGetTransferPrepayResponse:%@ OnRequest:%@]", self, arg1, arg2);
    ...
    _logos_orig$_ungrouped$WCPayLogicMgr$insideCallBackGetTransferPrepayResponse$OnRequest$(self, _cmd, arg1, arg2);
}
